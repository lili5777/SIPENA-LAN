    ...
    <div class="card border-0 shadow-lg">
        <div class="card-header bg-white py-3 border-0">
            <h5 class="card-title mb-0 fw-semibold">
                ...
                Form {{ $isEdit ? 'Edit' : 'Tambah' }} Evaluator
            </h5>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                ...
                                placeholder="Masukkan NIP evaluator (jika ada)">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                ...
                                placeholder="Contoh: Senior Evaluator, Konsultan, dll">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted mt-1 d-block"><i class="fas fa-info-circle me-1"></i>Status menentukan apakah evaluator masih aktif</small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <label for="email" class="form-label fw-semibold">
                                ...
                                @if($isEdit && optional($evaluator->user)->id)
                ...
                <div class="mb-4">
                    <div class="form-check form-switch d-flex align-items-center gap-3" style="padding-left:0;">
                        ...
                        <label class="form-check-label fw-semibold fs-6" for="buat_akun" style="color:#285496;cursor:pointer;">
                            Sekaligus buatkan akun login untuk Evaluator ini
                        </label>
                    </div>
                ...
                <div class="card border border-primary-subtle rounded-3 mb-4" style="background:#f8fbff;">
                    <div class="card-body pt-4">
                        <div class="alert alert-success d-flex align-items-center py-2 mb-4" role="alert">
                            ...
                            <div>Akun login aktif dengan email <strong>{{ $evaluator->user->email }}</strong>.
                ...
                <div class="mb-4">
                    <div class="form-check form-switch d-flex align-items-center gap-3" style="padding-left:0;">
                        ...
                        <label class="form-check-label fw-semibold fs-6" for="buat_akun" style="color:#285496;cursor:pointer;">
                            Buatkan akun login untuk Evaluator ini
                        </label>
                    </div>
                    <small class="text-muted ms-1 d-block mt-1">
                        <i class="fas fa-info-circle me-1"></i>Evaluator ini belum memiliki akun login. Aktifkan untuk membuatnya.
                    </small>
                </div>

{{-- resources/views/admin/gelombang/create.blade.php --}}
...
@section('content')
    <div class="page-header rounded-3 mb-4"
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1 class="text-white mb-1">Tambah Gelombang</h1>
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-white border-0 py-3">
                    <h5 class="mb-0 fw-semibold">
                        <i class="fas fa-layer-group me-2" style="color: #285496;"></i> Form Gelombang Baru
                    </h5>
                </div>
                    ...
                    <form action="{{ route('gelombang.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2 pt-2">
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i> Simpan Gelombang
                            </button>

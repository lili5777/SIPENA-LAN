        ...
        <div class="row align-items-center">
            <div class="col">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="text-white mb-1">Tambah Visi</h1>
                        <p class="text-white-50 mb-0">Tambahkan visi perusahaan</p>
                    </div>
                </div>
            </div>
            <div class="col-auto">
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-white py-3 border-0">
                    <h5 class="card-title mb-0 fw-semibold">
                        <i class="fas fa-eye me-2" style="color: #285496;"></i> Form Tambah Visi
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('visi-misi.visi.store') }}" method="POST">
                        @csrf
                        
                        <div class="mb-3">
                            <label for="visi" class="form-label fw-semibold">Isi Visi <span class="text-danger">*</span></label>
                            <textarea class="form-control" id="visi" name="visi" rows="4" 
                                      placeholder="Masukkan visi perusahaan..." required>{{ old('visi') }}</textarea>
                            @error('visi')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="ctt" name="ctt" 
                                   value="{{ old('ctt') }}" placeholder="Masukkan catatan (opsional)">
                            @error('ctt')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>

...
@section('title', 'Export Absensi Peserta - LAN Pusjar SKMP')
@section('page-title', 'Export Absensi Peserta')
...
@section('styles')
    <style>
        ...
        /* Style untuk kategori dan wilayah */
        .form-label .badge {
            font-size: 0.7rem;
    ...
    <div class="export-section">
        ...
        <div class="section-header">
            <div class="section-title">
                ...
                <span>Export Absensi Peserta (PDF)</span>
            </div>
        </div>

        <form action="{{ route('admin.export.absen') }}" method="GET" class="export-form" target="_blank" id="exportForm">
            <!-- Kategori (Opsional) -->
        ...
        <div class="export-info">
            <div class="export-info-header">
                ...
                <h4>Informasi Filter Export Absensi</h4>
            </div>
            ...
            <div class="template-comparison">
                <div class="template-item">
                    ...
                    <ul>
                        <li><strong>PNBP</strong> - Absensi peserta dengan kategori PNBP</li>
                        <li><strong>FASILITASI</strong> - Absensi peserta dengan kategori Fasilitasi</li>
            ...
            <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid #e2e8f0;">
                ...
                <p style="font-size: 0.9rem; color: #64748b; margin: 0;">
                    ...
                    1. Export akan menghasilkan file PDF dengan header di setiap halaman.<br>
                    ...
                    5. Wilayah menggunakan pencarian partial match (LIKE '%wilayah%').
                </p>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (exportForm && exportBtn) {
                exportForm.addEventListener('submit', function (e) {
                    ...
                    // Hilangkan animasi dari filter yang aktif

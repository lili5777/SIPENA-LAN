...
@section('content')
    <div class="export-section">
        ...
        <form action="{{ route('admin.export.absen') }}" method="GET" class="export-form" target="_blank">
            <!-- Jenis Pelatihan -->
        ...
        <div class="export-info">
            ...
            <p>
                <strong>Info:</strong> Pilih filter untuk mengekspor daftar hadir peserta. Data akan diekspor dalam format
                PDF
                dengan header di setiap halaman. Jika tidak memilih filter tertentu, semua data akan diekspor.
            </p>
        </div>
    </div>
@endsection

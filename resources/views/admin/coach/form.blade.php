...
@section('title', $isEdit ? 'Edit Coach' : 'Tambah Coach - Sistem Pelatihan')
...
@section('content')
        ...
        <div class="row align-items-center">
            <div class="col">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="text-white mb-1">{{ $isEdit ? 'Edit Coach' : 'Tambah Coach Baru' }}</h1>
                        <p class="text-white-50 mb-0">{{ $isEdit ? 'Perbarui data coach' : 'Tambah data coach baru' }}</p>
                    </div>
                </div>
            </div>
            <div class="col-auto">
                <a href="{{ route('coach.index') }}" class="btn btn-light btn-hover-lift shadow-sm d-flex align-items-center">
    ...
    <div class="card border-0 shadow-lg">
        ...
        <form method="POST"
            action="{{ $isEdit ? route('coach.update', $coach->id) : route('coach.store') }}"
            id="coachForm">
            @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                id="nip" name="nip"
                                value="{{ old('nip', $isEdit ? $coach->nip : '') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                ...
                                value="{{ old('jabatan', $isEdit ? $coach->jabatan : '') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('pangkat') is-invalid @enderror"
                                ...
                                value="{{ old('pangkat', $isEdit ? $coach->pangkat : '') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('status_aktif') is-invalid @enderror"
                                ...
                                <option value="1" {{ old('status_aktif', $isEdit ? $coach->status_aktif : '1') == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('status_aktif', $isEdit ? $coach->status_aktif : '') == '0' ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <label for="nomor_hp" class="form-label fw-semibold">
                                <i class="fas fa-phone me-1 text-primary"></i> Nomor HP Coach
                            </label>
                            <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror"
                                id="nomor_hp" name="nomor_hp"
                                value="{{ old('nomor_hp', $isEdit ? $coach->nomor_hp : '') }}"
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('nomor_rekening') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_rekening', $isEdit ? $coach->nomor_rekening : '') }}"
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <label for="npwp" class="form-label fw-semibold">
                                <i class="fas fa-file-invoice me-1 text-primary"></i> NPWP Coach
                            </label>
                            <input type="text" class="form-control @error('npwp') is-invalid @enderror"
                                id="npwp" name="npwp"
                                value="{{ old('npwp', $isEdit ? $coach->npwp : '') }}"
            ...
            <div class="card-footer bg-white py-3 border-0">
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{ route('coach.index') }}" class="btn btn-outline-secondary px-4">
    ...
    <div class="card border-0 shadow-sm mt-4">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2"><i class="fas fa-times-circle text-secondary me-2"></i><strong>Nonaktif:</strong> Coach tidak muncul dalam pilihan kelompok baru</li>

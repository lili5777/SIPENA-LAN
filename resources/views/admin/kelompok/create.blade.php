...
@section('content')
    <div class="page-header rounded-3 mb-4"
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1 class="text-white mb-1">Tambah Kelompok</h1>
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-white border-0 py-3">
                    <h5 class="mb-0 fw-semibold">
                        <i class="fas fa-users me-2" style="color: #285496;"></i> Form Kelompok Baru
                    </h5>
                </div>
                    ...
                    <form action="{{ route('kelompok.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_jenis_pelatihan" id="id_jenis_pelatihan"
                                    ...
                                    @foreach($jenisPelatihan as $jp)
                                        <option value="{{ $jp->id }}" {{ old('id_jenis_pelatihan') == $jp->id ? 'selected' : '' }}>
                                            {{ $jp->nama_pelatihan }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_mentor" id="id_mentor" class="form-select @error('id_mentor') is-invalid @enderror">
                                    ...
                                    @foreach($mentorList as $m)
                                        <option value="{{ $m->id }}" {{ old('id_mentor') == $m->id ? 'selected' : '' }}>
                                            {{ $m->nama_mentor }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_coach" id="id_coach" class="form-select @error('id_coach') is-invalid @enderror">
                                    ...
                                    @foreach($coachList as $c)
                                        <option value="{{ $c->id }}" {{ old('id_coach') == $c->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_penguji" id="id_penguji" class="form-select @error('id_penguji') is-invalid @enderror">
                                    ...
                                    @foreach($pengujiList as $p)
                                        <option value="{{ $p->id }}" {{ old('id_penguji') == $p->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="id_evaluator" id="id_evaluator" class="form-select @error('id_evaluator') is-invalid @enderror">
                                    ...
                                    @foreach($evaluatorList as $e)
                                        <option value="{{ $e->id }}" {{ old('id_evaluator') == $e->id ? 'selected' : '' }}>
                        ...
                        <div class="d-flex gap-2 pt-4">
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i> Simpan Kelompok
                            </button>
